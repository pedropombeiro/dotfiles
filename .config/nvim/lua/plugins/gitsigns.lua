      ...
      },
      {
        expr = true,
        {
          ...
          },
          {
            ...
            {
              "[gb",
              function() gs.toggle_current_line_blame(true) end,
              desc = "Enable current line blame",
            },
            {
              "[gd",
              function() gs.toggle_deleted(true) end,
          ...
          {
            "]gb",
            function() gs.toggle_current_line_blame(false) end,
            desc = "Disable current line blame",
          },
          {
            "]gd",
            function() gs.toggle_deleted(false) end,
