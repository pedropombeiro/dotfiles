...
op_account_id="FAHP7RACSJGZFL7LH3MCW2TH4M"
op_vault_id="t66tzrlha6547px6nc4nfhpgym" # Private
op_item_title="Memos OpenCode API token"
...
if command -v op >/dev/null 2>&1; then
  ...
  printf "${YELLOW}%s${NC}\n" "Could not read the Memos MCP token from the configured 1Password account and vault"
else
