...
omz update
find "${ZSH_CUSTOM:-${HOME}/.oh-my-zsh/custom}/themes" -mindepth 1 -maxdepth 1 -type d -print0 | xargs -0 -P 8 -I {} git -C {} pull --ff-only
find "${ZSH_CUSTOM:-${HOME}/.oh-my-zsh/custom}/plugins" -mindepth 1 -maxdepth 1 -type d -print0 | xargs -0 -P 8 -I {} git -C {} pull --ff-only
find "${HOME}/.vim/pack/" -type d -name .git -print0 | xargs -0 -P 8 -I {} git -C {}/.. pull --ff-only
