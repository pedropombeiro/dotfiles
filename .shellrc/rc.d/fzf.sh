...
export FZF_DEFAULT_OPTS="--height 40% --inline-info --border --ansi --bind ctrl-/:toggle-preview ${FZF_DEFAULT_COLOR} --preview 'bat --color=always --style=header,grid --line-range :300 {}'"
